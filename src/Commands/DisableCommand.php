...
class DisableCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'voyager-templates:disable';
     ...
     * @var string
     */
    protected $description = 'Disable the hook Voyager Templates';
    ...
    {
        return [
            ['disable', null, InputOption::VALUE_NONE, 'Disable the hook Voyager Templates', null],
        ];
    }
