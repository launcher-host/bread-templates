    ...
    public function seedVoyagerTemplates()
    {
        ...
        $template->fill([
            'view' => implode("\n", [
                ...
                '        <div class="panel panel-bordered">@stack("r01_lf")</div>',
                '    </div>',
                '    <div class="col-sm-4 col-md-4 col-lg-4">',
                '        <div class="panel panel-bordered">@stack("r01_rg")</div>',
                '    </div>',
                '</div>',
                '<div class="row">',
                '    <div class="col-sm-8 col-md-8 col-lg-8">',
                '        <div class="panel panel-bordered">@stack("r02_lf")</div>',
                '    </div>',
                '    <div class="col-sm-4 col-md-4 col-lg-4">',
                '        <div class="panel panel-bordered">@stack("r02_rg")</div>',
                '    </div>',
                '</div>',
            ]),
        ])->save();
